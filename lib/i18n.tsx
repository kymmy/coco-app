...
const fr: Record<string, string> = {
  ...
  "about.hostingDesc": "Coco est h\u00e9berg\u00e9 en Europe chez Vercel (Francfort). Vos donn\u00e9es sont soumises au RGPD.",
  "about.hostingProvider": "Vercel \u2014 Francfort, Allemagne",
  "about.hostingLocation": "R\u00e9gion eu-central-1 (Frankfurt)",
...
const en: Record<string, string> = {
  ...
  "about.hostingDesc": "Coco is hosted in Europe by Vercel (Frankfurt). Your data is subject to GDPR regulations.",
  "about.hostingProvider": "Vercel — Frankfurt, Germany",
  "about.hostingLocation": "eu-central-1 region (Frankfurt)",
